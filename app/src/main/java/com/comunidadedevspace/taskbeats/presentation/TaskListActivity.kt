...
class MainActivity : AppCompatActivity() {
    ...
    //Create (o insert que estamos fazendo)
    //Read (listagem através do getAll())
    //Update
    //Delete
    ...
    private fun insertIntoDataBase(task: Task){
        ...
        CoroutineScope(IO).launch {
            dao.insert(task)
            //Chamar a listagem para atualizar a UI (atualizar no adapter)
            //Precisa estar dentro da mesma thread para funcionar
            listFromDataBase()
        }
